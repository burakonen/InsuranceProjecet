...
namespace InsuranceProject.Migrations
{
    ...
    [Migration("20220710124021_GroupsAndUsersMapping")]
    partial class GroupsAndUsersMapping
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InsuranceProject.Context.GroupsAndUsers", b =>
                {
            ...
            modelBuilder.Entity("InsuranceProject.Context.GroupsAndUsers", b =>
                {
                    b.HasOne("InsuranceProject.Context.Groups", "Groups")
                        .WithMany("UsersAndGroups")
                        .HasForeignKey("GroupsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InsuranceProject.Context.Users", "Users")
                        .WithMany("UsersAndGroups")
