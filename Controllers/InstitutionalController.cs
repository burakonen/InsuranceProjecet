...
namespace InsuranceProject.Controllers
{
    ...
    public class InstitutionalController : Controller
    {
        ...
        public InstitutionalController(GetAllCategories getAllCategories)
        {
        ...
        public IActionResult Index()
        {
            ...
            var categoryGroups = _getAllCategories.GetCorporateCategorie();
        ...
        public IActionResult InsuranceForm(string url)
        {
            ...
            var model = context.InsuranceLists.Where(a => a.SEOURL == url).Include(s => s.PageDescriptions).Include(a => a.Category).ThenInclude(i => i.GroupsAndCategories.Where(a => a.Groups.Name == "kurumsal")).ThenInclude(a => a.Groups).FirstOrDefault();
